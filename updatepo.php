...
<head>
	...
	<title>Update Data PO - ADW</title>
			...
			<section class="content">
				<div class="box box-solid">
					...
					<?php 
						include 'koneksi.php'; 
						$ID_Po=$_GET['ID_Po'];
						$data=mysqli_query($koneksi,"SELECT * FROM po WHERE ID_Po='$ID_Po' ") or die(mysqli_error($koneksi));
						$baris=mysqli_fetch_array($data);
					 ?>
						<form class="" action="prosesupdatepo.php?ID_Po=<?php echo $ID_Po ?>" method="post" name="encoder" method=post>
						
		<div class="col-xs-6">
		<label for="No_Po">Nomor PO</label>
	 	<input type="text" class="form-control" name="No_Po" value="<?php echo $baris['No_Po'] ?>" required>

	 	<br><label for="Date_Po">Tanggal</label>
	 	<div class="input-group date" data-provide="datepicker">
		    <input type="text" class="form-control" name="Date_Po" value="<?php echo $baris['Date_Po'] ?>" required>
