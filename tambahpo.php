...
<head>
	...
	<title>Tambah Data PO - ADW</title>
		...
		<div class="content-wrapper">
			<section class="content">
				<div class="box box-solid">
					...
					<div class="box-body">
						<form class="" action="prosestambahpo.php" method="post" >
						
						
		<div class="col-xs-6">
		<label for="No_Po">Nomor PO</label>
		<input type="text" class="form-control" name="No_Po" value="" required>
		<br>
		<label for="Date_Po">Tanggal</label>				
		<div class="input-group date" data-provide="datepicker">
    <input type="text" class="form-control" name="Date_Po" required>
