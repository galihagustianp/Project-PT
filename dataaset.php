...
<head>
	...
	<title>Lihat Data Aset - ADW</title>
			...
			<section class="content">
				<div class="box box-solid">
					...
					<div class="box-header with-border">
						...
						<h3 class="box-title">Lihat Data Aset</h3>
					</div>
					...
					<div class="box-body">
						<table class="table">
							...
							<tbody>
								<?php 
								include'koneksi.php';
								$data=mysqli_query($koneksi,"SELECT * FROM aset") or die(mysqli_error($koneksi));
								foreach ($data as $baris) {
									?>
									<tr>
										
										<td><?php echo $baris['NoAset']?></td>
										<td><div><?php echo $baris['NameAset']?></div></td>
										<td><?php echo $baris['User']?></td>
										<td><?php echo $baris['Status']?></td>
										<td><?php echo $baris['No_Po']?></td>
										<td><a class="btn btn-warning" href="updateaset.php?ID_Aset=<?php echo $baris['ID_Aset']?>">Update</a>
										<a class="btn btn-danger" href="hapusaset.php?ID_Aset=<?php echo $baris['ID_Aset']?>">Hapus</a>
										<a href="dekripsiaset.php?ID_Aset=<?php echo $baris['ID_Aset']?>" class="btn btn-warning" >Dekripsi</a></td>
									</tr>
								<?php }
								?>
								 </table>
