...
<head>
	...
	<title>Tambah Data Aset - ADW</title>
		...
		<div class="content-wrapper">
			<section class="content">
				<div class="box box-solid">
					...
					<div class="box-body">
						<form class="" action="prosestambahaset.php" method="post" name="encoder" method=post>
						<p><select name="encdec">
						   <option value="1">Enkripsi
						   <option value="-1">Dekripsi
						</select>
						<input type=checkbox name="doubleencode">
						<input onclick="myFunction()" value="?" type="reset"></input>
...
function myFunction() {
  alert("Keterangan :\n\n1. Enkripsi : Dapat Enkripsi Data \n2. Dekripsi : Dapat Dekripsi Data\n3. Checkbox : Dapat Enkripsi Ganda Kata");
		...
		<input type="text" class="form-control"  name="NoAset" required>
		

		<br><label for="NameAset">Nama Aset</label>
		<br><textarea name="text" class="form-control" style="resize: none;" required></textarea><br>
		<select>
		...
		<!-- <a href="#" onclick="insert_spaces(); return false;">Tambah X</a> -
		<a href="#" onclick="insert_spasi(); return false;">Tambah Q</a> - 
		<a href="#" onclick="only_letters(); return false;">Hanya Huruf</a> </p>
		 -->
		<br><P>Hasil Enkripsi</P>
		<textarea id='output' type="text" class="form-control" name="NameAset" style="resize: none;" readonly=""> </textarea><br>	
		...
		<br><label for="No_Po">Nomor PO</label>
		<select type="integer" class="form-control" name="No_Po" required>
		<?php
		include "koneksi.php";
