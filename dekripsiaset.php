...
<head>
	...
	<title>Dekripsi Data Aset - ADW</title>
			...
			<section class="content">
				<div class="box box-solid">
					...
					<div class="box-header with-border">
						...
						<h3 class="box-title">Dekripsi Nama Aset</h3>
					</div>
...
function myFunction() {
  alert("Keterangan :\n\n1. Enkripsi : Dapat Enkripsi Data \n2. Dekripsi : Dapat Dekripsi Data\n3. Checkbox : Dapat Enkripsi Ganda Kata");
		...
		<label for="NoAset">Nomor Aset</label>
	 	<input type="text" class="form-control" name="NoAset" value="<?php echo $baris['NoAset'] ?>" readonly="">

	 	<br><label for="NameAset">Nama Aset</label>
	 	<textarea name="text" class="form-control" name="NameAset" readonly=""><?php echo $baris['NameAset'] ?></textarea>

	 	<br><label for="NameAset">Hasil Dekripsi</label>
		...
		<input type="integer" class="form-control" name="User" value="<?php echo $baris['User'] ?>" readonly="">
			

	 	<br><label for="Status">Status</label>
	 	<input type="text" class="form-control" name="Status" value="<?php echo $baris['Status'] ?>" readonly="">

	 	<br><label for="Nomor_Po">Nomor PO</label>
	 	<input type="integer" class="form-control" name="No_Po" value="<?php echo $baris['No_Po'] ?>" readonly="">
