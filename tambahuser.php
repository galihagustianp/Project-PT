...
<head>
  ...
  <title>Tambah Data User - ADW</title>
    ...
    <div class="content-wrapper">
      <section class="content">
        <div class="box box-solid">
          ...
          <div class="box-body">
            <form class="" action="prosestambahuser.php" method="post" name="encoder" method=post>
...
function myFunction() {
  ...
  <label for="Nama_User">Nama User</label>
    ...
    <a href="#" onclick="only_letters(); return false;">Hanya Huruf</a> </p>
     -->
    <P>Hasil Enkripsi</P>
    <textarea id='output' type="text" class="form-control" name="Nama_User" style="resize: none;" readonly=""> </textarea><br> 
    
    <label for="Bagian">Departemen</label>
    <input type="text" class="form-control" name="Bagian" value="" required>
    
    <br><button class="btn btn-primary" type="submit" name="button">Simpan</button>
