...
function myFunction() {
  alert("Keterangan :\n\n1. Enkripsi : Dapat Enkripsi Data \n2. Dekripsi : Dapat Dekripsi Data\n3. Checkbox : Dapat Enkripsi Ganda Kata");
		...
		<div class="col-xs-6">
			...
			<br><textarea name="text" class="form-control" style="resize: none;" required=""><?php echo $baris['Nama_User'] ?></textarea><br>
		    <select>
			...
			<input type="text" class="form-control" name="Bagian" value="<?php echo $baris['Bagian'] ?>">
