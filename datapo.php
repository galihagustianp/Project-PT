			...
			<section class="content">
				<div class="box box-solid">
					...
					<div class="box-header with-border">
						...
						<h3 class="box-title">Lihat Data PO</h3>
					</div>
					...
					<div class="box-body">
						<table class="table">
							...
							<tbody>
								<?php 
								include'koneksi.php';
								$data=mysqli_query($koneksi,"SELECT * FROM po") or die(mysqli_error($koneksi));
								foreach ($data as $baris) {
									?>
									<tr>
										
										<td><?php echo $baris['No_Po']?></td>
										<td><?php echo $baris['Date_Po']?></td>
										<td><a class="btn btn-warning" href="updatepo.php?ID_Po=<?php echo $baris['ID_Po']?>">Update</a>
										<a class="btn btn-danger" href="hapuspo.php?ID_Po=<?php echo $baris['ID_Po']?>">Hapus</a></td>
									</tr>
								<?php }
								?>
								 </table>
